...
class Observation( TimeStampModel ):
    user_id                         = models.ForeignKey( SystemUser, on_delete = models.PROTECT, related_name = "observation_user" )
    ...
    area_id                         = models.ForeignKey( Area, on_delete = models.PROTECT, null = True, blank = True, related_name = "observation_area" )
    area_name                       = models.CharField( 'area name', max_length = 50, default = "" )
    zone_name                       = models.CharField( 'zone name', max_length = 50, default = "" )
    company_id                      = models.ForeignKey( Company, on_delete = models.PROTECT, null = True, blank = True, related_name = "observation_company" )
    ...
    type_id                         = models.ForeignKey( ObservationType, on_delete = models.PROTECT, related_name = "observation_type", null = True, blank = True )
